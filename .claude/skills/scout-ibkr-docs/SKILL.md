...
3. **Reconcile** the scouts' findings yourself (main context, small distilled inputs): what's agreed, what conflicts, what nobody covers. Apply the claim taxonomy below to every field-presence statement.
