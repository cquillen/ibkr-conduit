...
public class AlertOperationsTests
{
    ...
    public async Task GetAlertsAsync_DelegatesToApi()
    {
        ...
        _api.GetAlertsAsync(Arg.Any<string>(), Arg.Any<CancellationToken>()).Returns(expected);
    ...
    public async Task GetMtaAlertAsync_DelegatesToApi()
    {
        ...
        _api.GetMtaAlertAsync(Arg.Any<CancellationToken>()).Returns(expected);
    ...
    public async Task GetAlertDetailAsync_DelegatesToApi()
    {
        ...
        _api.GetAlertDetailAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<CancellationToken>()).Returns(expected);
