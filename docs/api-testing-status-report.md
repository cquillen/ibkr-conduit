...
| `/iserver/account/search/{pattern}` | GET | OpenAPI | Yes + 401 | DYNACCT only — returns 503 on non-DYNACCT accounts; synthetic WireMock fixture |
| `/iserver/dynaccount` | POST | OpenAPI | Yes + 401 | DYNACCT only — returns 401 on non-DYNACCT accounts; synthetic WireMock fixture |
